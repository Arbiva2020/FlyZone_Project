...
const GaugeChart = ({ chartData, gaugeScore }) => {
  ...
  const gaugeChartText = {
    ...
    afterDatasetDraw(chart) {
      ...
      ctx.fillText(gaugeScore, xCoor, yCoor); // Draw text at specified coordinates, this value will come from the database
    
      ctx.font = '15px sans-serif';
      ctx.textBaseline = 'bottom'; // Set baseline for positioning
      ctx.textAlign = 'center'
      ctx.fillText('Fair', left+100, yCoor-35); // Draw text at specified coordinates
    }
  };
